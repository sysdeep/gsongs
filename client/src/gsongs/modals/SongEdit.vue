			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-5">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control" v-model="item.singer">
											<option v-for="(singer, index) in singers" :key="index" :value="singer.id">
												{{ singer.name }}
											</option>
										</select>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea class="form-control" rows="3" id="inputDescription" placeholder="Описание"
						...
						<div class="col-md-7">
							<textarea class="form-control mono" rows="25" id="inputText" placeholder="Текст"
