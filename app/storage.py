...
class Song(Base):
	...
	name 	= peewee.CharField(db_column='name')
	author 	= peewee.CharField(db_column='author')
	album 	= peewee.CharField(db_column='album')
	text 	= peewee.CharField(db_column='text')
	description 	= peewee.CharField(db_column='description')
